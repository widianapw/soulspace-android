package com.soulspace.app.domain.voice_to_text
...
//        Log.d("VoiceToTextParser", "startListening")
    ...
    fun stopListening() {
//        Log.d("VoiceToTextParser", "stopListening")
        _state.update { it.copy(isSpeaking = false) }
        recognizer.stopListening()
    }

    override fun onReadyForSpeech(p0: Bundle?) {
//        Log.d("VoiceToTextParser", "onReadyForSpeech")
...
//        Log.d("VoiceToTextParser", "onEndOfSpeech")
        _state.update { it.copy(isSpeaking = false) }
    }

    override fun onError(p0: Int) {
//        Log.d("VoiceToTextParser", "onError: $p0")
